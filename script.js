const translations = {
    ...
    en: {
        ...
        olesBackstoryPageTitle: "Oles's Backstory — VOLYA",
        olesBackstoryMainHeading: "Oles's Backstory",
        olesBackstoryHeroTagline: "A modern warrior carrying millennia of struggle for Volya.",
        olesBackstorySectionTitle: "A Hardened Modern Warrior",
        olesBackstoryBirthDateLabel: "Date of Birth:",
        olesBackstoryBirthDateValue: "Approx. 2000.",
        olesBackstoryChildhoodHeading: "Childhood and Youth (2000-2022):",
        olesBackstoryChildhoodText: "Oles was born and raised in an ordinary Ukrainian family. It was a typical pro-Ukrainian family that deeply valued its history, language, culture, and traditions. He was raised on the principles of patriotism, respect for elders, and love for his homeland. In childhood, Oles was an active and curious boy, fond of sports and history, especially the Cossack era. He grew up in a world of relative stability, dreaming of a normal life, perhaps related to engineering or IT – something that would yield concrete results and improve life. He wasn't a military man by calling, but the values instilled by his family shaped his character – responsible, persistent, with a sense of justice.",
        olesBackstoryWarBeginningHeading: "Beginning of the War and the Warrior's Path (2022):",
        olesBackstoryWarBeginningText: "When the full-scale invasion began in February 2022, Oles's life, like millions of Ukrainians, changed forever. Without hesitation, immediately after the first strikes, he volunteered for the military enlistment office. His motivation was crystal clear – to protect his home, his family, his country from an enemy who sought to destroy everything he loved. Initial training was intensive, but Oles, thanks to his physical fitness and internal composure, quickly adapted to the harsh realities.",
        olesBackstoryWarHardeningHeading: "Forging by Fire (2022-2030):",
        olesBackstoryWarHardeningText1: "Over eight years of war, until 2030, Oles went from a recruit to a truly <span class=\"highlight\">professional and battle-hardened warrior</span>. He saw firsthand the hell of the fiercest battles, lost comrades, endured the heaviest shelling and trench warfare. His path lay through the defense of Kyiv, bloody battles in the east, counteroffensives, and months of exhausting confrontation.",
        olesBackstoryWarHardeningHighlight1: "professional and battle-hardened warrior",
        olesBackstoryWarHardeningText2: "His specialization became <span class=\"highlight\">reconnaissance and assault operations</span> – he was there where it was necessary to penetrate deepest into the enemy's rear or break through the strongest defense. Oles learned to think outside the box, make instant decisions under immense pressure, and his survival and combat skills in the most difficult conditions became legendary among comrades. His inner world, though hardened and grayed by war, never lost that spark of \"Volya\" – an unbreakable faith in victory and readiness to go to the end. He became a living embodiment of the Cossack spirit – not only through combat skills, but also through inner freedom, defiance, and loyalty to his land.",
        ...
        olesBackstoryFinalBattleText: "By 2030, when Ukraine began its decisive offensive, Oles became one of the most experienced and valuable fighters. He had rank, the respect of commanders, and unwritten leadership among his peers. Pain, fatigue, and numerous scars were part of his essence, but his eyes burned with the same determination as at the beginning, only now it was joined by a deeper understanding of the price of the struggle. He was in Marinka, on the front line of the Ukrainian offensive, ready for the final, decisive battle for Donbas. It was here, in this historic and symbolic place, that he was destined to face not only the last challenges of the war but also the call of the thousand-year-old \"Volya\" of his ancestors, which must manifest itself at a critical moment.",
        olesBackstoryBackButton: "← Return to main page",
